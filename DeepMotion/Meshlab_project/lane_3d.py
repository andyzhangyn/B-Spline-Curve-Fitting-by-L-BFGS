...
class Lane3D():
    ...
    def RANSAC_Quadratic_Interpolation(self, data, niter=100, threshold=12):
...
if __name__ == '__main__':
    ...
    for i in range(100, 187):
        ...
        lane3d = Lane3D()
        curve = lane3d.fit(lane_mask)

        print(curve)
        print(curve.shape)

        curve_path = "/home/yuanning/DeepMotion/curves/curve_{}.off".format(files[i])
